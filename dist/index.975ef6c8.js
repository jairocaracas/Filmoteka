...
var _renderMoviesJs = require("./js/render-movies.js");
var _fetchTrendsJs = require("./js/fetch-trends.js");
var _fetchMovieJs = require("./js/fetch-movie.js");
let moviesGallery = document.querySelector(".movies-gallery");
(0, _renderMoviesJs.renderMovieCards)((0, _fetchTrendsJs.fetchTrends)(), moviesGallery);
moviesGallery.addEventListener("click", (0, _fetchMovieJs.fetchMovie));

},{"./js/render-movies.js":"88vdl","./js/fetch-trends.js":"ddPSu","./js/fetch-movie.js":"biubg"}],"88vdl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMovieCards", ()=>renderMovieCards);
var _fetchGenresJs = require("./fetch-genres.js");
async function renderMovieCards(fetchFunction, div) {
    let renderCards = await fetchFunction;
    div.innerHTML = " ";
    let newRender = await Promise.all(renderCards.map(async ({ genre_ids , id , poster_path , release_date , title  })=>{
        let genre = await (0, _fetchGenresJs.getGenreById)(genre_ids);
...
},{"./fetch-genres.js":"kTQBL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kTQBL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getGenreById", ()=>getGenreById);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _optionsJs = require("./options.js");
async function fetchGenre() {
    try {
        const response = await (0, _axiosDefault.default).get("https://api.themoviedb.org/3/genre/movie/list?language=en", (0, _optionsJs.options));
...
async function getGenreById(id) {
    ...
    let filtered = genres.map((genre)=>{
        for(let i = 0; i < id.length; i++)if (genre.id === id[i]) newArray.push(genre.name);
    });
    // console.log(newArray);
    return newArray;
}

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./options.js":"4A9N4"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4A9N4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const options = {
    ...
    headers: {
        ...
        Authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMjZlZTYxMDllYjU2ZDliMTA3YjQ5ZDdkMzI2MDVlNyIsInN1YiI6IjY0Y2M0Y2EwZTA0ZDhhMDBhZDkwYWUzYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.NQpWpJBbEEcJq_7S3bfg-ke5HFKJDM34MJvFESDabEo"
    }
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ddPSu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function fetchTrends() {
    try {
        const response = await (0, _axiosDefault.default).get("https://api.themoviedb.org/3/trending/movie/day?language=en-US&page=1", (0, _optionsJs.options));
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./options.js":"4A9N4"}],"biubg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchMovie", ()=>fetchMovie);
function fetchMovie(e) {
    e.preventDefault;
    if (e.target.nodeName === "IMG") console.log(e.target.getAttribute("id"));
}
